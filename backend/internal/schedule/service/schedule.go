...
func (s *ScheduleService) GetCurrentScheduleForTeacher(teacherID int, filter scheduleModels.ScheduleFilter) ([]scheduleModels.ScheduleLesson, error) {
	if teacherID <= 0 {
...
func (s *ScheduleService) RolloverSchedules(classID int) (*scheduleModels.ScheduleRolloverResult, error) {
	return s.schedules.RolloverSchedules(classID)
}

func (s *ScheduleService) ResetPlannedSchedules(classID int) (*scheduleModels.ScheduleResetResult, error) {
	return s.schedules.ResetPlannedSchedules(classID)
}

func (s *ScheduleService) deleteScheduleLesson(scheduleType string, input scheduleModels.UpdateSchedulesInput) (*scheduleModels.UpdateSchedulesResult, error) {
	id := input.ID
	if id <= 0 {
...
func (s *ScheduleService) upsertScheduleLesson(scheduleType string, input scheduleModels.UpdateSchedulesInput) (*scheduleModels.UpdateSchedulesResult, error) {
