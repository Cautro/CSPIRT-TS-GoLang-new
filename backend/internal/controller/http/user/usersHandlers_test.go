...
// // 	nRepo  := notesRepo.NewNoteRepository(db)
// // 	cRepo  := complaintsRepo.NewComplaintRepository(db)
// // 	clRepo := classRepo.NewClassRepository(db)
// // 	eRepo  := eventsRepo.NewEventsRepository(db)

// // 	sr := sr.NewUsersService(
// // 		uRepo,
// // 		nRepo,
// // 		cRepo,
// // 		clRepo,
...
// // 	router := handlertest.NewRouter(users.Owner.Login)
// // 	router.PATCH("/api/user/add", AddUserHandler(sr))
