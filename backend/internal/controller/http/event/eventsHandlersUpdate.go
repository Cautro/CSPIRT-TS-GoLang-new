...
func UpdateEventParamsHandler(eventService *sr.EventsUsecase, perm *permissionService.Usecase) func(ctx *gin.Context) {
...
func UpdateEventHandler(eventService *sr.EventsUsecase, perm *permissionService.Usecase) func(ctx *gin.Context) {
	return func(ctx *gin.Context) {
		err := perm.CheckUserRole(ctx.GetString("Login"), "owner")
		if err != nil {
			logger.WriteSafe(logger.LogEntry{
