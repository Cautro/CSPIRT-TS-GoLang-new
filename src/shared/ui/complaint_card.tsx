...
export function ComplaintCard({ item, role, onDelete }: Props) {
        ...
        >
            <div className="class-flat-card__main">
                ...
                <div className="class-flat-card__info">
                    <h2 className="class-flat-card__subtitle">От {item.AuthorName}</h2>
                ...
                <div className="class-flat-card__info">
                    <h2 className="class-flat-card__subtitle">{item.Content}</h2>
                </div>
            </div>

            <div className="class-flat-card__meta">
                <div className="class-flat-card__metric">
                    <span className="class-flat-card__metric-label">Создана</span>
